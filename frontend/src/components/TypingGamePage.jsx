      ...
      <div className="game-page-header">
        <div className="game-info">
          ...
          <div className="game-details">
            <h1>Написание слов</h1>
            <p>Проверьте свою грамотность - печатайте перевод слов</p>
            <div className="game-difficulty medium">Уровень: Средний</div>
          </div>
        </div>
      </div>
